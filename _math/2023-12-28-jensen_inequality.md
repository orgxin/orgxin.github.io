---
title: '琴生不等式（Jensen Inequality）'
collection: blogs
date: 2023-12-28
permalink: /math/2023-12-28-jensen_inequality
excerpt: 'Jensen Inequality的介绍'
---

**Jensen Inequality** 就是一个简单的定理，但是用于很广，常用于定理的证明中，极大的简化了推公式的速度。

在机器学中，如**KL-divergence恒大于或等于零**，用Jensen inequality证明就很简洁，亦或是**最大熵模型**、**EM算法**的证明都需要用到它。因此，有必要透彻了解JS是干什么的，他是从何处来，要到哪里去！

# 写在前面

在介绍JS之前，必须要知道什么是**凸函数**以及它有哪些性质，因此JS就是凸函数性质的推广（我猜的）。秉承着一图胜千言的传统，能够用图说话就不用文字，直接上图：

<div align='center'>
    <img src='./images/convex_function.png' width="50%">
</div>

**凸函数定义：**对任意$x_1,x_2\in(a, b)$，且$\lambda \in [0,1]$，满足

$$
f(\lambda x_1+(1-\lambda) x_2)\leqslant \lambda f(x_1)+(1-\lambda)f(x_2)
$$

则称$f(x)$在区间$(a,b)$上是凸的。当且仅当$\lambda=0或1$，上式成立，则$f(x)$是严格凸的。

<div align='center'>
    <img src='./images/convex_function_1.png' width="60%">
</div>

**凸函数定理：**若函数$f$在某个区间存在非负（正）的二阶导数，则$f$为该区间为凸函数（严格凸函数）。
...
采用琴生不等式证明KL散度恒等于或等于零，KL散度计算公式如下：
...
* [琴生不等式(Jenson’s Inequality) - 郑之杰的个人网站 (0809zheng.github.io)](https://0809zheng.github.io/2022/07/20/jenson.html)
